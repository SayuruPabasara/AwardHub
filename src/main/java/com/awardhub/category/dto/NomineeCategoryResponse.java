...
public class NomineeCategoryResponse {
    ...
    private boolean isNominationOpen;

    public NomineeCategoryResponse() {}
    ...
    public boolean isNominationOpen() {
        return isNominationOpen;
    }

    public void setNominationOpen(boolean nominationOpen) {
        isNominationOpen = nominationOpen;
    }
}
